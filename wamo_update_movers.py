...
</style></head><body><div class="app"><nav><a href="./">🇰🇷 한국 대시보드</a><a href="us.html">🇺🇸 미국 대시보드</a><a class="active" href="movers.html">🚀 오늘의 상승률 TOP 30</a></nav><div class="sub">WAMO DAILY MOVERS · 재무가 확인된 중형·대형 일반기업 상승률 순위</div><div class="sub"><b>자동갱신(KST) · 한국 12:00 / 16:00 · 미국 00:00 / 06:20 · 시장별 하루 2회</b></div><h1>재무안정 중대형주 상승률 TOP 30</h1><div class="sub">한국은 시총 1조원, 미국은 시총 20억달러 이상에서 시작합니다. 공식 재무제표로 자본·순이익이 양수인지 확인하고, 비금융사는 부채비율 300% 이하를 추가 확인합니다. 조건 통과 종목이 30개보다 적으면 억지로 채우지 않습니다.</div><div class="bar"><div class="tabs"><button id="krBtn" onclick="setMarket('korea')">한국</button><button id="usBtn" onclick="setMarket('us')">미국</button></div><div class="meta" id="meta"></div></div><div class="summary" id="summary"></div><div class="grid" id="grid"></div><div class="note">정배열 = 종가 &gt; 20일선 &gt; 60일선 &gt; 120일선 &gt; 200일선. 재무안정 PASS는 투자등급이나 부도 가능성 보증이 아니라 최신 공식 재무제표의 최소 안전장치입니다. 금융사는 업종 특성상 일반기업의 부채비율·유동비율을 적용하지 않고 자본과 순이익만 확인합니다. 한국은 OpenDART를 사용합니다. 미국은 SEC EDGAR XBRL을 우선 사용하고, GitHub Actions에서 SEC 접속이 차단되면 Nasdaq 연간 재무제표로 동일한 최소기준을 검사합니다. 어느 쪽에서도 재무를 확인할 수 없는 종목은 제외합니다.</div></div>
