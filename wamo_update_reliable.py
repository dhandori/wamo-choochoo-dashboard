...
UA = "Mozilla/5.0 (WAMO-Market-Radar/17.0)"
...
def main():
    ...
    print("7/8 FnGuide/WiseReport 현재 컨센서스 + 4주 리비전 이력 연결")
    ...
    payload = {
        "meta": {
            ...
            "source": "Yahoo Finance price + NAVER market-cap/fallback + KRX KIND industry + OpenDART official fundamentals/disclosures + NAVER foreign/institution flow estimate + FnGuide/WiseReport consensus",
